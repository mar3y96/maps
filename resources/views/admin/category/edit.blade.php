...
@section('content')
	...
	<div class="page-bar">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li>
				<a href="{{ url('admin/courses/category/'.$category->id.'/edit') }}">  تعديل {{ $category->name_ar }} </a>
			</li>
		</ul>
	...
	<div class="tab-pane active" id="tab_6">
		...
		<div class="portlet box blue ">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-gift"></i> تعديل تخصص {{ $category->name_ar}}
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
					...
					@include('admin.category._form',['process'=>'edit'])
					{!! Form::close()!!}
				<!-- END FORM-->
			</div>
		</div>
